...
if WetMeasurements %Also assumes diluted exhaust
    ...
    if datastream('Options').Part_1065.HCContaminationCorrection
        if datastream('Options').Use_HC
            HCAccess = ['HC_',Bench,'_Corrected'];
        else
            HHCAccess = ['HHC_',Bench,'_Corrected'];
        end
    end
    ...
    part1065.CO_l_m = datastream('Options').Molar_Mass.CO.*part1065.n_exh.*datastream('Options').delta_T.* ...
        (datastream(COlAccess).ConvertStreaming('mol/mol',DataToUse)-1e-6*datastream(COlAccess).Ambient.([ConcentrationsToUse 'Average'])*part1065.x_dilexh);
    ...
    if datastream.isKey(COhAccess)
        ...
        (datastream(COhAccess).ConvertStreaming('mol/mol',DataToUse)-1e-2*datastream(COhAccess).Ambient.([ConcentrationsToUse 'Average'])*part1065.x_dilexh);
    ...
    part1065.CO2_m = datastream('Options').Molar_Mass.CO2.*part1065.n_exh.*datastream('Options').delta_T.* ...
        (datastream(CO2Access).ConvertStreaming('mol/mol',DataToUse)-1e-2*datastream(CO2Access).Ambient.([ConcentrationsToUse 'Average'])*part1065.x_dilexh);
    ...
    part1065.NOx_m = datastream('Options').Molar_Mass.NOx.*part1065.n_exh.*part1065.NOx_cor.*datastream('Options').delta_T.* ...
        (datastream(NOxAccess).ConvertStreaming('mol/mol',DataToUse)-1e-6*datastream(NOxAccess).Ambient.([ConcentrationsToUse 'Average'])*part1065.x_dilexh);
    ...
    if datastream.isKey(N2OAccess)
        ...
        (datastream(N2OAccess).ConvertStreaming('mol/mol',DataToUse)-1e-6*datastream(N2OAccess).Ambient.([ConcentrationsToUse 'Average'])*part1065.x_dilexh);
    ...
    if datastream('Options').Use_HC
        part1065.HC_m_c = datastream('Options').Molar_Mass.HC.*part1065.n_exh.*datastream('Options').delta_T.* ...
            (datastream('HC_Bag_Dilute_Corrected').ConvertStreaming('mol/mol',DataToUse)-1e-6*datastream('HC_Bag_Dilute_Corrected').Ambient.([ConcentrationsToUse 'Average'])*part1065.x_dilexh);
        ...
        part1065.HC_m = datastream('Options').Molar_Mass.HC.*part1065.n_exh.*datastream('Options').delta_T.* ...
            (datastream('HC_Bag_Dilute').ConvertStreaming('mol/mol',DataToUse)-1e-6*datastream('HC_Bag_Dilute').Ambient.([ConcentrationsToUse 'Average'])*part1065.x_dilexh);
        ...
        if datastream.isKey(['HHC_',Bench])
            part1065.HHC_m = datastream('Options').Molar_Mass.HC.*part1065.n_exh.*datastream('Options').delta_T.* ...
                (datastream('HHC_Bag_Dilute').ConvertStreaming('mol/mol',DataToUse)-1e-6*datastream('HHC_Bag_Dilute').Ambient.([ConcentrationsToUse 'Average'])*part1065.x_dilexh);
        ...
        part1065.HHC_m_c = datastream('Options').Molar_Mass.HC.*part1065.n_exh.*datastream('Options').delta_T.* ...
            (datastream('HHC_Bag_Dilute_Corrected').ConvertStreaming('mol/mol',DataToUse)-1e-6*datastream('HHC_Bag_Dilute_Corrected').Ambient.([ConcentrationsToUse 'Average'])*part1065.x_dilexh);
    ...
    if datastream.isKey(CO2egrAccess)
        part1065.CO2_egr_m = datastream('Options').Molar_Mass.CO2.*part1065.n_exh.*datastream('Options').delta_T.* ...
            (datastream(CO2egrAccess).ConvertStreaming('mol/mol',DataToUse)-1e-2*datastream(CO2egrAccess).Ambient.([ConcentrationsToUse 'Average'])*part1065.x_dilexh);
    ...
    if datastream.isKey(CO2TrAccess)
        part1065.CO2_Tr_m = datastream('Options').Molar_Mass.CO2.*part1065.n_exh.*datastream('Options').delta_T.* ...
            (datastream(CO2TrAccess).ConvertStreaming('mol/mol',DataToUse)-1e-2*datastream(CO2TrAccess).Ambient.([ConcentrationsToUse 'Average'])*part1065.x_dilexh);
    ...
    if datastream.isKey(O2Access)
        part1065.O2_m = datastream('Options').Molar_Mass.O2.*part1065.n_exh.*datastream('Options').delta_T.* ...
            (datastream(O2Access).ConvertStreaming('mol/mol',DataToUse)-1e-2*datastream(O2Access).Ambient.([ConcentrationsToUse 'Average'])*part1065.x_dilexh);
    ...
    if datastream.isKey(['CH4_',Bench,'_Corrected'])
        part1065.CH4_m_c = datastream('Options').Molar_Mass.CH4.*part1065.n_exh.*datastream('Options').delta_T.* ...
            (datastream(CH4Access).ConvertStreaming('mol/mol',DataToUse)-1e-6*datastream(CH4Access).Ambient.([ConcentrationsToUse 'Average'])*part1065.x_dilexh);
        ...
        part1065.CH4_m = datastream('Options').Molar_Mass.CH4.*part1065.n_exh.*datastream('Options').delta_T.* ...
            (datastream('CH4_Bag_Dilute').ConvertStreaming('mol/mol',DataToUse)-1e-6*datastream('CH4_Bag_Dilute').Ambient.([ConcentrationsToUse 'Average'])*part1065.x_dilexh);
    ...
    if datastream.isKey(NMHCAccess)
        part1065.NMHC_m = datastream('Options').Molar_Mass.HC.*part1065.n_exh.*datastream('Options').delta_T.* ...
            (datastream(NMHCAccess).ConvertStreaming('mol/mol',DataToUse)-1e-6*datastream(NMHCAccess).Ambient.([ConcentrationsToUse 'Average'])*part1065.x_dilexh);
